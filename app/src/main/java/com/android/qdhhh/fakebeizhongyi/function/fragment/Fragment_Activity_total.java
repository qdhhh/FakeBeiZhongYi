 ...
 */
public class Fragment_Activity_Total extends Fragment {
    ...
    public Fragment_Activity_Total() {
    ...
    private void getData() {
        ...
        params.put("IsSecret", 0);
        params.put("page", 1);

        kj.post(UrlAddress.getURLAddress(UrlAddress.Url_GetAtCoterie),
                    ...
                    public void onSuccess(String t) {
                        ...
                        try {
                            ...
                            if ("200".equals(str)) {
                                ...
                                setData(new JSONObject(t).getString("atlist"));
                            }
